...
export function InventoryClient({ inventories }: InventoryClientProps) {
    ...
    const columns: ColumnDef<Inventory>[] = useMemo(() => [
        ...
        },
        {
            ...
            label: '批号',
            width: 140,
            render: (value) => <code className="text-xs bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded font-mono">{value}</code>,
        },
        {
            key: 'production_date',
            label: '生产日期',
        ...
        },
        {
            ...
            label: '货位',
            width: 100,
            render: (value) => <code className="text-xs bg-blue-50 dark:bg-blue-900/20 text-blue-600 px-1.5 py-0.5 rounded font-mono">{value}</code>,
        },
        {
            key: 'quantity',
            label: '数量',
