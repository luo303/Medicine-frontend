        ...
        <div className="flex flex-col h-full p-6 space-y-4 overflow-hidden">
                        ...
                        <DialogContent className="sm:max-w-[500px]">
                            ...
                            <div className="grid gap-4 py-4">
                                <div className="grid grid-cols-4 items-center gap-4">
                                    <label className="text-right text-sm text-slate-600">仓库编号 <span className="text-red-500">*</span></label>
                                    <Input 
                            ...
                            <div className="flex justify-end gap-2">
                                <Button variant="outline" onClick={() => { setDialogOpen(false); resetWarehouseForm(); }}>取消</Button>
                                <Button 
                                        ...
                                        <div className="flex items-center justify-between p-4 cursor-pointer hover:bg-slate-50/50 dark:hover:bg-slate-700/20 transition-colors">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <Button 
                                                    ...
                                                    onClick={(e) => { e.stopPropagation(); openEditWarehouseDialog(warehouse); }}
                                                >
                                                    编辑
                                                </Button>
                                                <Button 
            ...
            <Dialog open={locationDialogOpen} onOpenChange={setLocationDialogOpen}>
                <DialogContent className="sm:max-w-[400px]">
                    ...
                    <div className="grid gap-4 py-4">
                        <div className="grid grid-cols-4 items-center gap-4">
                            <label className="text-right text-sm text-slate-600">货位编号 <span className="text-red-500">*</span></label>
                            <Input 
                                className="col-span-3" 
                    ...
                    <div className="flex justify-end gap-2">
                        <Button variant="outline" onClick={() => { setLocationDialogOpen(false); resetLocationForm(); }}>取消</Button>
                        <Button 
                            className="bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white"
