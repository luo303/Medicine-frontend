...
export async function createStorageLocation(
  params: CreateStorageLocationParams,
...
export async function updateStorageLocation(
  id: number,
  params: UpdateStorageLocationParams,
): Promise<StorageLocation> {
...
export async function createMedicalInstitution(
  params: CreateMedicalInstitutionParams,
...
export async function updateMedicalInstitution(
  ...
  return putApi<MedicalInstitution>(
    `/MedicalInstitution/${approval_no}`,
    params,
  );
}

export async function deleteMedicalInstitution(
  approval_no: string,
): Promise<void> {
...
export async function updatePurchaseDetail(
  id: number,
  params: UpdatePurchaseDetailParams,
): Promise<PurchaseDetail> {
...
export async function createPurchaseStorage(
  params: CreatePurchaseStorageParams,
): Promise<PurchaseStorage> {
  return postApi<PurchaseStorage>("/purchase/storage", params);
}

export async function updatePurchaseStorage(
  id: number,
  params: UpdatePurchaseStorageParams,
): Promise<PurchaseStorage> {
...
export async function createSalesDetail(
  params: CreateSalesDetailParams,
): Promise<SalesDetail> {
...
export async function updateSalesDetail(
  id: number,
  params: UpdateSalesDetailParams,
): Promise<SalesDetail> {
...
export async function createSalesOutbound(
  params: CreateSalesOutboundParams,
): Promise<SalesOutbound> {
  return postApi<SalesOutbound>("/sales/outbound", params);
}

export async function updateSalesOutbound(
  id: number,
  params: UpdateSalesOutboundParams,
): Promise<SalesOutbound> {
